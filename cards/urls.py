...
urlpatterns = [
    ...
    path("f/new/", views.card_create, name="card-create"),  # /new/
    path("new/", views.CardCreateView.as_view(), name="card-create"),  # /new/
    path("f/edit/<int:pk>/", views.update_view, name="card-create"),  # /new/
    path("edit/<int:pk>/", views.CardUpdateView.as_view(), name="card-create"),  # /new/
]
